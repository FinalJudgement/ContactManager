...
$(function () {
  ...
  $(document).on("click", "#addNewEmail", function () {
    ...
    if (validateEmail(emailAddress)) {
      $("#emailList").append(
        '<li class="list-group-item emailListItem" data-email="' +
          emailAddress +
          '" data-type="' +
          emailAddressType +
          '">' +
  ...
  $(document).on("click", "#addNewAddress", function () {
    ...
    $("#addressList").append(
      '<li class="list-group-item addressListItem" data-street1="' +
        street1 +
        '" data-street2="' +
        street2 +
        '" data-city="' +
  ...
  $(document).on("click", "#saveContactButton", function () {
    ...
    function validateInputs(data) {
      ...
      if (data.Title == "") {
        $("#editContactTitle").addClass("invalidInput");
        $("#invalidTitleFeedback").show();
        isValid = false;
      }
      ...
      if (data.DOB == "") {
        $("#editContactDOB").addClass("invalidInput");
        $("#invalidDOBFeedback").show();
        isValid = false;
      }
    ...
    let data = {
      ContactId:
        $("#contactId").val() || "00000000-0000-0000-0000-000000000000",
